  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        ⊘ NDIDS hash verification architecture ready — Phase 2
      </div>
      <div style={{ marginTop: 48, fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: '#3a4a6a', letterSpacing: '1px' }}>
        ...
        No real citizen credentials are held. Contact: synergyblockchaintf@gmail.com
      </div>
    </div>
  )
}
  ...
  return (
    <ResearchGate storageKey="sdpi_verify_acknowledged">
      <StubPortal
        ...
        phase="PHASE 2"
        description="Public credential verification portal. Allows third parties to verify government-issued credentials against the NDIDS hash registry without exposing citizen identity data."
      />
    </ResearchGate>
  )
}
